...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="<%=basePath%>goAlterUserPass" target="right"><span class="icon-caret-right"></span>修改密码</a></li>
    <%-- <li><a href="<%=basePath%>backstage/ckcomments.html" target="right"><span class="icon-caret-right"></span>审查评论</a></li> --%>
  </ul> 
</div>
<div class="admin">
  <iframe scrolling="auto" rameborder="0" src="<%=basePath%>goAlterUserPass" name="right" width="100%" height="100%"></iframe>
</div>
