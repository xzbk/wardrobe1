...
<div class="header bg-main">
  ...
  <div class="head-l" style="float: right; margin-right: 50px;" >
	  <a class="button button-little bg-red" href="<%=basePath%>adminLogout"><span class="icon-power-off"></span> 退出</a>
  </div>
</div>
<div class="leftnav">
  ...
  <ul style="display:block">
    ...
    <li><a href="<%=basePath%>goAddAdmin" target="right"><span class="icon-caret-right"></span>新增管理员</a></li>
    <li><a href="<%=basePath%>queryAllAdmin" target="right"><span class="icon-caret-right"></span>查看管理员</a></li>
  </ul> 
</div>
<div class="admin">
