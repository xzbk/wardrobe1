...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="<%=basePath%>addAdmin">
	  ...
	  <div class="form-group">
	    ...
	    <div class="field">
	      <input type="text" class="input w50" name="repassword" value="" data-validate="required:请确认密码" />         
	      <div class="tips"></div>
	    </div>
	  </div>
      <div class="form-group">
        ...
        <div class="field">
          <select class="input w50" name="type.id">
          	<c:forEach items="${types }" var="item" varStatus="status">
          		<c:if test="${status.index==0&&item.id!=1 }">
